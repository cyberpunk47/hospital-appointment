...
@section('title', 'Add Doctor - Hospital Appointment Management')
...
<div class="create-container">
    <div class="page-header">
        <div>
            ...
            <p style="color:#6b7280; font-size:0.9rem; margin-top:4px;">Add a new doctor to the registry with dynamic clinical hours and automatic slot configuration.</p>
        </div>
        ...
        <form action="{{ route('doctors.store') }}" method="POST">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" placeholder="Dr. First Last" required>
                </div>
                <div class="form-group">
                    <label for="license_number">License Registration Number</label>
                    <input type="text" name="license_number" id="license_number" class="form-control" value="{{ old('license_number') }}" placeholder="e.g. MCI-12345" required>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" class="form-control" value="{{ old('email') }}" placeholder="doctor@hospital.com" required>
                </div>
                <div class="form-group">
            ...
            <div class="form-row" style="margin-bottom: 32px;">
                <div class="form-group" style="grid-column: span 2;">
                    ...
                    <input type="text" name="specialization" id="specialization" class="form-control" value="{{ old('specialization') }}" placeholder="e.g. Cardiology, Pediatrics" required>
                </div>
            </div>
            ...
            <div class="form-group" style="margin-bottom: 32px; margin-top: 20px;">
                ...
                <textarea name="address" id="address" class="form-control" rows="3" placeholder="Room no, Building name, Clinic lane, etc.">{{ old('address') }}</textarea>
            </div>
            ...
            <div class="form-row" style="margin-bottom: 32px;">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="daily_limit" id="daily_limit" class="form-control" value="{{ old('daily_limit', 15) }}" min="1" max="100" required>
                </div>
                <div class="form-group">
...
<script>
    ...
    // Initialize dropdown on reload if previously submitted
    if (oldState) {
